<template>
    ...
    <div class="MainContent"> 
        <div class="LoginContent"> 
            ...
            <el-form v-if="IfLogin" ref="loginFormRef" :model="LoginFrom" :rules="fromrules" label-width="120px">
            ...
            <!--注册框-->
            <el-form v-else ref="registerFormRef" :model="RegisterFrom" :rules="fromrules" label-width="120px">
                <el-form-item label="账号" prop="Account">
